...
extension ColorResource {
    ...
    static let automatic = ColorResource(name: "Automatic", bundle: resourceBundle)
    ...
    static let blackWhite = ColorResource(name: "BlackWhite", bundle: resourceBundle)

    /// The "BlackWhiteSecondary" asset catalog color resource.
    static let blackWhiteSecondary = ColorResource(name: "BlackWhiteSecondary", bundle: resourceBundle)
    ...
    static let blueYellow = ColorResource(name: "BlueYellow", bundle: resourceBundle)

    /// The "BlueYellowSecondary" asset catalog color resource.
    static let blueYellowSecondary = ColorResource(name: "BlueYellowSecondary", bundle: resourceBundle)
    ...
    static let manual = ColorResource(name: "Manual", bundle: resourceBundle)

    /// The "ProgressLineBackground" asset catalog color resource.
    static let progressLineBackground = ColorResource(name: "ProgressLineBackground", bundle: resourceBundle)
